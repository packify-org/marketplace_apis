...
class Product(SellerApiBaseModel):
    ...
    * Если товар не уценённый или был уценён Ozon — ``false``."""
    discounted_stocks: ProductStock | None = None
    ...
    Ценовой индекс."""
    price_indexes: ProductPriceIndex | None = None
    ...
    stocks: ProductStock | None = None
    """Информация об остатках товара."""
    updated_at: datetime | None = None
    """Дата последнего обновления товара."""
    vat: str | None = None
    """Ставка НДС для товара."""
    visibility_details: ProductVisibilityDetails | None = None
